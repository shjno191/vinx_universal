...
import { gitBranches, gitTabRepoPath, projectRootPath, Icons, type GitBranch } from '@vinx/sdk';
...
const filteredBranches = computed(() => {
    return gitBranches.value.filter((b: GitBranch) => b.name.toLowerCase().includes(filter.value.toLowerCase()));
});

const localBranches = computed(() => filteredBranches.value.filter((b: GitBranch) => !b.isRemote));
const remoteBranches = computed(() => filteredBranches.value.filter((b: GitBranch) => b.isRemote));
